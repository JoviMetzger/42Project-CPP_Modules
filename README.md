...
### 📌 Sequence Containers
#### ➖ Vector:
Think of a vector like a resizable array. 
You have a series of numbered slots, and you can put items in any of those slots.
It's like having a list of boxes where you can add more boxes as needed, 
...
You can add or remove links anywhere in the chain.
...
You add items to the top of the stack, and the last item you added is the first one you take out.
Think of it like a pile of books where you can only add or remove books from the top of the stack.
...
You add elements to the back of the queue and remove them from the front.
It's like waiting in line for a rollercoaster ride where the first person who joined the line gets on the ride first.
